...
export const AboutSection = () => {
  const stats = [
    ...
    { icon: <Award className="w-6 h-6" />, number: "14", label: "წლიანი გამოცდილება" },
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            ...
            2019 წლიდან ვემსახურებით ჩვენს ერთგულ კლიენტებს.
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-4">
                რატომ უნდა აირჩიოთ ფხიზელი მძღოლის სერვისი?
              </h3>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  24/7 ზე ვუზრუნველყოფთ თქვენი და თქვენი ავტომობილის 
                  უსაფრთხო გადაადგილებას.
                </p>
                <p>
                  ერთ ერთი პირველები ვართ ბაზარზე 14 წლიანი გამოცდილებით.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="space-y-3">
                {[
                  ...
                  "მისაღები ფასები და გამჭვირვალე ტარიფები",
