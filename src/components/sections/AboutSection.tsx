      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mb-6">
            ფხიზელი მძღოლი - ჩვენს შესახებ
          </h2>
          <p className="text-lg text-muted-foreground max-w-2xl mx-auto">
            სანდო 24 საათიანი სერვისი გამოცდილი მძღოლებით სრული კონფიდენციალურობით - 
            2019 წლიდან ვემსახურებით ქართულ საზოგადოებას ქალაქის ყველა რაიონში
          </p>
        </div>
          ...
          <div className="space-y-8">
            <div>
              <h3 className="text-2xl font-bold text-foreground mb-4">
                რატომ არის ფხიზელი მძღოლი სანდო სერვისი?
              </h3>
              <div className="space-y-4 text-muted-foreground">
                <p>
                  ფხიზელი მძღოლი - პირველი სანდო 24 საათიანი სერვისი საქართველოში 
                  ნასვამი მძღოლების მომსახურებისთვის. ჩვენი გამოცდილი მძღოლები 
                  უზრუნველყოფენ სრული კონფიდენციალურობით მომსახურებას.
                </p>
                <p>
                  ჩვენი ყველა გამოცდილი მძღოლი გავლილია სპეციალურ ტრენინგს და 
                  მუშაობს ქალაქის ყველა რაიონში. ვართ ლიცენზირებული სანდო სერვისი 
                  სრული იურიდიული უზრუნველყოფით და კონფიდენციალურობით.
                </p>
              </div>
            </div>
